        ...
        return `
            <div class="relative group overflow-hidden bg-slate-800/20 rounded-xl border border-white/5 transition-all duration-500 hover:border-yellow-500/30">
                ...
                <div class="relative p-5 flex items-center gap-6">
                    <div class="relative w-24 h-12 shrink-0 bg-slate-900 rounded-lg border border-white/10 overflow-hidden shadow-xl">
                        <img src="${serie.immagine_url}" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700">
                        ${isAdmin ? `
                    ...
                    <div class="flex-1">
                        <div class="flex items-center gap-2 mb-1">
                            <span class="text-[8px] font-black text-yellow-500 uppercase tracking-[0.2em]">Serie ID</span>
                            <span class="text-[8px] text-slate-500 font-mono">${serie.id.substring(0, 8)}...</span>
                        </div>
                    ...
                    ${isAdmin ? `
                        <div class="flex flex-col gap-2">
                            <button title="Gestisci Testate e Annate" class="p-2 bg-slate-900 text-slate-400 hover:text-yellow-500 rounded-lg border border-white/5 transition-colors">
