...
export const form = {
    ...
    SELECT: (id, options, selectedId = '') => `
        <select id="${id}" class="bg-slate-800/50 border border-slate-700 text-white text-sm rounded-lg focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500 block w-full p-2.5 outline-none transition-all cursor-pointer">
