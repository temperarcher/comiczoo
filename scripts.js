...
function setFilter(filter) {
    ...
    // Ricarica la vista attuale usando il nome memorizzato
...
async function selectSerie(id, fullNome) {
    currentSerieId = id;
    currentSerieFullNome = fullNome; // Salva il titolo per i filtri successivi
...
async function loadRecent() {
    currentSerieId = null;
    currentSerieFullNome = "Ultimi Arrivi"; // Salva il titolo
