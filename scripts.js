...
function setFilter(filter) {
    ...
    // Usa currentSerieFullNome per non perdere il titolo durante il filtraggio
...
async function selectSerie(id, fullNome) {
    ...
    // Mantiene l'aggiornamento immediato del titolo
    document.getElementById('view-title').innerText = fullNome;
    ...
    // Ordinamento: data crescente e nullsFirst false
...
async function loadRecent() {
    ...
    document.getElementById('view-title').innerText = currentSerieFullNome;
